...
namespace Bike_Race
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            Classes.Data.bettor[1] = new Guy() { bet = null, name = Classes.Data.gamblers[1], label = player2Bet, cash = 75, radioBtn = radioButton2 };
            Classes.Data.bettor[2] = new Guy() { bet = null, name = Classes.Data.gamblers[2], label = player3Bet, cash = 65, radioBtn = radioButton3 };
